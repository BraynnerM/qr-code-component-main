...
Esta é uma solução para o desafio do Frontend Mentor [QR Code component main challenge on Frontend Mentor](https://www.frontendmentor.io/challenges/qr-code-component-iux_sIO_H/hub). Os desafios do Frontend Mentor ajudam a melhorar minhas habilidades de codificação criando projetos realistas.
...
- URL da solução: [Github](https://github.com/BraynnerM/qr-code-component-main)
-  URL do site no Github Pages: [QR code component main](https://braynnerm.github.io/qr-code-component-main/)
